...
#   filename:  https://json.schemastore.org/sarif-2.1.0.json
#   timestamp: 2023-10-08T06:50:34+00:00
...
class DeprecatedGuid(RootModel[str]):
    root: str = Field(
        ...,
...
class Address(BaseModel):
    ...
    absolute_address: Optional[int] = Field(
        -1,
...
class RunAutomationDetails(BaseModel):
    ...
    correlation_guid: Optional[str] = Field(
        None,
...
class EdgeTraversal(BaseModel):
    ...
    step_over_edge_count: Optional[int] = Field(
        None,
...
class Region(BaseModel):
    ...
    char_length: Optional[int] = Field(
        None,
        alias='charLength',
    ...
    byte_length: Optional[int] = Field(
        None, alias='byteLength', description='The length of the region in bytes.', ge=0
    )
...
class ToolComponent(BaseModel):
    ...
    dotted_quad_file_version: Optional[str] = Field(
        None,
...
class ResultProvenance(BaseModel):
    ...
    first_detection_run_guid: Optional[str] = Field(
        None,
    ...
    last_detection_run_guid: Optional[str] = Field(
        None,
...
class Invocation(BaseModel):
    ...
    exit_code: Optional[int] = Field(
        None, alias='exitCode', description='The process exit code.'
    )
...
class Run(BaseModel):
    ...
    baseline_guid: Optional[str] = Field(
        None,
        alias='baselineGuid',
